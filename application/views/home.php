...
<li><span style="color:#777;margin-right:14px;"><?= date("m-d-Y",human_to_unix($entry->created)); ?>&nbsp;</span><a href="/wall/get/<?=$entry->id?>"><?= character_limiter($entry->title,30) ?></a></li>
<?php } ?>
</ul>
</div>
<div class="col-md-4">
<ul style="list-style-type: none;line-height:1.5;">
<h3>Picture</h3>
<?php foreach ($picture as $entry){ ?>
<li><span style="color:#777;margin-right:14px;"><?= date("m-d-Y",human_to_unix($entry->created)); ?></span>&nbsp;<a href="/picture/get/<?=$entry->id?>"><?= character_limiter($entry->title,30) ?></a></li>
<?php } ?>
</ul>
</div>
<div class="col-md-4">
...
<li><span style="color:#777;margin-right:14px;"><?= date("m-d-Y",human_to_unix($entry->created)); ?></span>&nbsp;<a href="/info/get/<?=$entry->id?>"><?= character_limiter($entry->title,30) ?></a></li>
<?php } ?>
</ul>
</div>
</div>
